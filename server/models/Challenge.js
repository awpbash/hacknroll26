...
class Challenge {
  ...
  static async create(challengeData) {
    ...
    const docRef = await challengesCollection.add({
      ...
      existingInfrastructure: challengeData.existingInfrastructure || null,
      companyLogo: challengeData.companyLogo || null,
      companyName: challengeData.companyName || null,
      tags: challengeData.tags || [],
      videoSolutionUrl: challengeData.videoSolutionUrl || null,
      acceptanceRate: 0,
      submissions: 0,
      accepted: 0,
      createdAt: timestamp,
